      ...
      <div className="about-container" id="about">
        <div className="about">
          ...
          <div className="about-text">
            ...
            <p className="about-text__block">
              Currently I am enrolled at the University of Toronto, St. George
              campus, aiming to graduate in November 2020. I enjoy working with
              various object oriented languages such as Python, Java and C#, as
              well as Javascript and its various frameworks. I love learning new
              things and further expanding my reportoire of skills, currently
              exploring the ins and outs of Typescript. In my leisure time I
              like to watch shows, play games and create designs.
            </p>
          </div>
          ...
          <p className="about-related">
            Related Projects: {titles !== "" && titles.slice(2)}
          </p>
        </div>
      </div>
    );
